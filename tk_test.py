                        ...
                        if choice <= len(Addlist):
                            if choice >= 1:
                                        ...
                                        if dada == Adapterlist[choice - 1]:  #os popen probably gives output in windowed mode check here
                                            ...
                                            try:
                                                ...
                                                if registry_value[33:62] == 'NetworkAddress does not exist':
                                                    ...
                                                    #print('works here 142')
                                                    os.system(set_value + " -Value " + random_mac)

                                            except Exception as e:
                                                #print('no works on 139',e)
                                                jlsdfsdf = 10
                                except Exception as e:
                                    pass
                                ...
                                try:
                                    ...
                                    '''
                                    subprocess.Popen('powershell netsh interface set interface name="Wi-Fi" admin=disabled',shell=True,stderr=subprocess.DEVNULL,stdout=subprocess.DEVNULL)
                                    subprocess.Popen('powershell netsh interface set interface name="Wi-Fi" admin=enabled',shell=True,stderr=subprocess.DEVNULL,stdout=subprocess.DEVNULL)
                                    subprocess.Popen('powershell netsh interface set interface name="tap" admin=disabled',shell=True,stderr=subprocess.DEVNULL,stdout=subprocess.DEVNULL)
                                    subprocess.Popen('powershell netsh interface set interface name="tap" admin=enabled',shell=True,stderr=subprocess.DEVNULL,stdout=subprocess.DEVNULL)
                                    subprocess.Popen('powershell netsh interface set interface name="Ethernet" admin=disabled',shell=True,stderr=subprocess.DEVNULL,stdout=subprocess.DEVNULL)
                                    subprocess.Popen('powershell netsh interface set interface name="Ethernet" admin=enabled',shell=True,stderr=subprocess.DEVNULL,stdout=subprocess.DEVNULL)
                                    '''
